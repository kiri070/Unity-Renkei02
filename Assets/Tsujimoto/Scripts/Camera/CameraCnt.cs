...
//     //壁の処理(前フレームで遮蔽物として扱われていたオブジェクトが格納される)
...
//     void WallChecker()
//     {
//         //それぞれのプレイヤーとのオブジェクト間のベクトルを取得
//         Vector3 dir1 = (player1.transform.position - transform.position).normalized;
//         Vector3 dir2 = (player2.transform.position - transform.position).normalized;

//         //Rayの(開始地点, 進む方向)
//         Ray ray1 = new Ray(this.transform.position, dir1);
//         Ray ray2 = new Ray(this.transform.position, dir2);

//         //Rayが衝突した全てのコライダーの情報を取得
//         RaycastHit[] rayCastHits1 = Physics.RaycastAll(ray1);
//         RaycastHit[] raycastHits2 = Physics.RaycastAll(ray2);

//         //前フレームで遮蔽物であったすべてのGameObjectを保持
//         prevRaycast = raycastHitsList.ToArray();
//         raycastHitsList.Clear();


//         foreach (RaycastHit hit in rayCastHits1)
//         {
